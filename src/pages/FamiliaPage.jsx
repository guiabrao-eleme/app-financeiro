      ...
      {!show ? (
        ...
        <div className="w-full space-y-3">
          <input type="text" value={nome} onChange={e => setNome(e.target.value)}
            ...
            className="w-full px-4 py-3 rounded-2xl border border-slate-200 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100 dark:placeholder-slate-400 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 text-center font-medium" />
