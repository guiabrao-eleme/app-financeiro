        ...
        {gcal.connected ? (
          ...
          <div className="mx-4 mt-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 rounded-2xl px-4 py-3 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-blue-700 dark:text-blue-300">Sincronize com o Google Calendar</p>
              <p className="text-[11px] text-blue-500 dark:text-blue-400 mt-0.5">Conecte em Perfil para sync automático</p>
            </div>
          </div>
        )}
